...
function autoupgrade_init_container($callerFilePath)
{
    ...
    $container = new \QloApps\Module\AutoUpgrade\UpgradeContainer(_PS_ROOT_DIR_, _PS_ADMIN_DIR_);
    $container->getState()->importFromArray(empty(json_decode($_REQUEST['params'], true)) ? array() : json_decode($_REQUEST['params'], true));
