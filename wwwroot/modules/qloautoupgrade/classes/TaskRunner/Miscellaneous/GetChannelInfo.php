...
namespace QloApps\Module\AutoUpgrade\TaskRunner\Miscellaneous;

use QloApps\Module\AutoUpgrade\ChannelInfo;
use QloApps\Module\AutoUpgrade\TaskRunner\AbstractTask;
use QloApps\Module\AutoUpgrade\Twig\Block\ChannelInfoBlock;
...
class GetChannelInfo extends AbstractTask
{
    public function run()
    {
        ...
        $channel = isset(json_decode($_REQUEST['params'], true)['channel']) ? json_decode($_REQUEST['params'], true)['channel'] : $this->container->getUpgradeConfiguration()->getChannel() ;
