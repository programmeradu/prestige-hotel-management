...
use QloApps\Module\AutoUpgrade\AjaxResponse;
use QloApps\Module\AutoUpgrade\BackupFinder;
use QloApps\Module\AutoUpgrade\Parameters\UpgradeFileNames;
use QloApps\Module\AutoUpgrade\UpgradePage;
use QloApps\Module\AutoUpgrade\UpgradeSelfCheck;
use QloApps\Module\AutoUpgrade\Tools14;
...
class AdminSelfUpgradeController extends AdminController
{
    ...
    {
        return (new \QloApps\Module\AutoUpgrade\UpgradeTools\Translator(__CLASS__))->trans($id, $parameters, $domain, $locale);
    }
}