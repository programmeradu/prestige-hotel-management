  ...
  var input = {
    ...
    translation: {
      ...
      todoList: [
        ...
        "Templates have been updated, Please recompile templates and clear QloApps cache",
        "Please check that your front-office theme is functional (try to create an account, place an order...)",
        "Room type or hotels images do not appear in the front-office? Try regenerating the thumbnails in Preferences > Images",
  ...
  function refreshChannelInfos() {
    ...
    $.ajax({
      ...
      data: {
        ...
        ajaxMode: "1",
        params: JSON.stringify({channel: val})
      },
