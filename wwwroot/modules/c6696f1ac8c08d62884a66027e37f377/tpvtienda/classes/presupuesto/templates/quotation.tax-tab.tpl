...
<table style="width: 100%">
	<tr>
		<td>
			{if $tax_exempt}
				{l s='Exempt of VAT according section 259B of the General Tax Code.' mod='tpvtienda'}
			{else}
			<table>
				<tr style="line-height:5px;">
					<td style="text-align: left; background-color: #4D4D4D; color: #FFF; padding-left: 10px; font-weight: bold; width: {if !$use_one_after_another_method}30%{else}60%{/if}">{l s='Detalle impuestos' mod='tpvtienda'}</td>
					<td style="text-align: right; background-color: #4D4D4D; color: #FFF; padding-left: 10px; font-weight: bold; width: 20%">{l s='Porcentaje' mod='tpvtienda'}</td>
					{if !$use_one_after_another_method}
						<td style="text-align: right; background-color: #4D4D4D; color: #FFF; padding-left: 10px; font-weight: bold; width: 30%">{l s='Total (sin imp.)' mod='tpvtienda'}</td>
					{/if}
					<td style="text-align: right; background-color: #4D4D4D; color: #FFF; padding-left: 10px; font-weight: bold; width: 20%">{l s='Total Impuestos' mod='tpvtienda'}</td>
				</tr>
				...
				{if isset($ecotax_tax_breakdown)}
					{foreach $ecotax_tax_breakdown as $ecotax_tax_infos}
						...
						<tr style="line-height:6px;background-color:{cycle values='#FFF,#DDD'};">
							<td style="width: {if !$use_one_after_another_method}30%{else}60%{/if}">{l s='Ecotasa' mod='tpvtienda'}</td>
