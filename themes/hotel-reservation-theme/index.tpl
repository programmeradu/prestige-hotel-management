...
{* 4. Christmas Animation Section *}
<link rel="stylesheet" href="{$css_dir}christmas.css" type="text/css" media="all" />

<section id="christmasAnimationBlock" class="christmas-section py-80">
    <div class="container">
        <div class="section-header">
            <h2 class="section-title" style="color: #fff;">Season's Greetings</h2>
            <div class="title-underline"></div>
            <p class="section-description" style="color: #ccc;">Wishing you a magical holiday season from everyone at Prestige Hotel.</p>
        </div>
