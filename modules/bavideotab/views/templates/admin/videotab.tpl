...
<input value="{$id_product|escape:'htmlall':'UTF-8'}" class="hidden" type="hidden" id="product" name="id_product" />
        ...
        <div class="col-md-9">
            <p class="radio">
                <label id="embed" onclick="embed()">
                    <input type="radio"  name="type_video"  value="0" {if empty($file)} checked {/if}>
            ...
            <p class="radio">
                <label id="upload" onclick="upload()">
                    <input type="radio"  name="type_video" value="1" {if !empty($file)} checked {/if}>
