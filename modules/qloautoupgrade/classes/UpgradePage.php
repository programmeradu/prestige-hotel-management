...
use QloApps\Module\AutoUpgrade\Twig\Block\RollbackForm;
use QloApps\Module\AutoUpgrade\Twig\Block\UpgradeButtonBlock;
use QloApps\Module\AutoUpgrade\Twig\Block\UpgradeChecklist;
use QloApps\Module\AutoUpgrade\Twig\Form\BackupOptionsForm;
use QloApps\Module\AutoUpgrade\Twig\Form\FormRenderer;
use QloApps\Module\AutoUpgrade\Twig\Form\UpgradeOptionsForm;
use QloApps\Module\AutoUpgrade\Parameters\UpgradeConfiguration;
use QloApps\Module\AutoUpgrade\UpgradeTools\Translator;
...
class UpgradePage
{
    ...
    private function getJsParams($ajaxResult)
    {
        ...
        $jsParams = array(
            ...
            'translation' => array(
                ...
                'todoList' => array(
                    ...
                    $translator->trans('Templates have been updated, Please recompile templates and clear QloApps cache', array(), $translationDomain),
                    ...
                    $translator->trans('Room type or hotels images do not appear in the front-office? Try regenerating the thumbnails in Preferences > Images', array(), $translationDomain),
        ...
        if (!empty($this->upgrader->todolist)) {
            $jsParams['translation']['todoList'] = array_merge($jsParams['translation']['todoList'], $this->upgrader->todolist);
        }
