...
class ModuleAdapter
{
    ...
    public function upgradeModule($id, $name)
    {
        ...
        $addons_url = Upgrader::BASE_DOMAIN;
        ...
        foreach ($protocolsList as $protocol => $port) {
            ...
            if ($this->getModuleClass()->runUpgradeModule($name)) {
                return true;
            }
        }
