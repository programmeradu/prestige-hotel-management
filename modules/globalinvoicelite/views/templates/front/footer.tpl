...
*}
<table style="width: 100%; vertical-align:top; text-align: center; font-size: 6pt; color: #444; line-height:1pt;">
	<tr>
		<td style="width:87%;">
			{if Configuration::get('FSPA_texto_en_footer',Context::getContext()->language->id) != ''}
				{Configuration::get('FSPA_texto_en_footer',Context::getContext()->language->id)}
			{else}
