...
<table id="total-tab" width="100%">
    ...
    {if $totalDescuentos != 0}
        <tr>
            <td class="grey" width="60%">{l s='Total Descuentos' mod='tpvtienda'}</td>
    ...
    {if $totalShipping > 0}
        <tr class="bold">
            <td class="grey" width="60%">{l s='Envio' mod='tpvtienda'}</td>
    ...
    {if $totalWithoutTax > 0}
        <tr class="bold">
            <td class="grey" width="60%">{l s='Total (sin imp.)' mod='tpvtienda'}</td>
    ...
    {if $totalIva > 0}
        <tr class="bold">
            <td class="grey" width="60%">{l s='Total Impuestos' mod='tpvtienda'}</td>
            <td class="white" width="40%">{displayPrice currency=$cart->id_currency price=$totalIva}</td>
        </tr>
    {/if}
    <tr class="bold big">
        <td class="grey" width="60%">{l s='Total' mod='tpvtienda'}</td>
